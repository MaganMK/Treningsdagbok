...
public class HTTPServerTest {
	...
	public void testCreateClient() throws ClientProtocolException, IOException {
		...
		HttpClient   httpClient    = HttpClientBuilder.create().build();
		HttpPost     post          = new HttpPost(postUrl);
		StringEntity postingString = new StringEntity("name=Lise&phone=12345678&age=17&motivation=sugardaddy&trainerID=2", "utf-8");
	...
	public void testPutClient() throws ClientProtocolException, IOException {
		...
		StringEntity puttingString = new StringEntity("name=Lise&phone=12345678&age=17&motivation=sugardaddy&trainerID=2", "utf-8");
	...
	public void testCreateStrengthExercise() throws ClientProtocolException, IOException {
		...
		HttpClient   httpClient    = HttpClientBuilder.create().build();
		HttpPost     post          = new HttpPost(postUrl);
		StringEntity postingString = new StringEntity("reps=4&sett=3&weight=17&note=dritbra&sessionId=1&exerciseId=6", "utf-8");
